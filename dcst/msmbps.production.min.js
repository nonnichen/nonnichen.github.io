...
a));a.handleClick=a.handleClick.bind(a);return a}_inherits(b,c);_createClass(b,[{key:"handleClick",value:function(){var a=this.props.url,b=a.indexOf("://")+3,c=a.indexOf("/",b);a=a.substring(b,c);this.props.shownotice22(this.props.provider,this.props.locationName,a,this.props.download)}},{key:"render",value:function(){return React.createElement("span",{className:"name",onClick:this.handleClick,style:{cursor:void 0==this.props.download?"help":"pointer"}},this.props.locationName,React.createElement(Tip,
...
{milliseconds:this.props.milliseconds}),React.createElement(Name,{locationName:this.props.name,download:this.props.download,provider:this.props.provider,url:this.props.url,shownotice22:this.props.shownotice22}),React.createElement(Bar,{milliseconds:this.props.milliseconds,maxMilliseconds:this.props.maxMilliseconds}))}}]);return b}(React.Component),List=function(c){function b(a){_classCallCheck(this,b);a=_possibleConstructorReturn(this,(b.__proto__||Object.getPrototypeOf(b)).call(this,a));a.state={millisecondsOfTargets:[],
...
null),React.createElement("div",{style:{textAlign:"center"}},React.createElement("a",{className:"larger",href:"javascript:void(0);",onClick:this.reload},"Reload"),React.createElement("span",null,"\u00a0\u00a0\u00a0\u00a0\u00a0\u00a0"),React.createElement("a",{className:"larger",href:"javascript:void(0);",onClick:this.props.hideMessage},"Close")))}}]);return b}(React.Component),notice22=function(c){function b(a){_classCallCheck(this,b);a=_possibleConstructorReturn(this,(b.__proto__||Object.getPrototypeOf(b)).call(this,
a));a.handleClick=a.handleClick.bind(a);return a}_inherits(b,c);_createClass(b,[{key:"handleClick",value:function(){void 0!=this.props.clickedDownload&&(this.props.allProvidersFinished()||this.props.showMessage(),window.open(this.props.clickedDownload,"_blank"))}},{key:"render",value:function(){return React.createElement("div",{className:"notice22",style:{visibility:this.props.notice22Visible?"visible":"hidden"}},React.createElement("span",{className:"bold"},this.props.clickedProvider),React.createElement("br",
...
null),"for further testing"),React.createElement("br",null),React.createElement("br",null),React.createElement("a",{className:"larger",href:"javascript:void(0);",onClick:this.props.hidenotice22},"Close")))}}]);return b}(React.Component),App=function(c){function b(a){_classCallCheck(this,b);a=_possibleConstructorReturn(this,(b.__proto__||Object.getPrototypeOf(b)).call(this,a));a.state={allData:data,messageVisible:!1,notice22Visible:!1,clickedProvider:"",clickedName:"",clickedServer:"",clickedDownload:""};
a.data={countOfFinishedProviders:0};a.providerFinished=a.providerFinished.bind(a);a.allProvidersFinished=a.allProvidersFinished.bind(a);a.showMessage=a.showMessage.bind(a);a.hideMessage=a.hideMessage.bind(a);a.shownotice22=a.shownotice22.bind(a);a.hidenotice22=a.hidenotice22.bind(a);return a}_inherits(b,c);_createClass(b,[{key:"providerFinished",value:function(){this.data.countOfFinishedProviders++}},{key:"allProvidersFinished",value:function(){return this.data.countOfFinishedProviders==Object.keys(this.state.allData).length}},
{key:"showMessage",value:function(){this.setState({messageVisible:!0})}},{key:"hideMessage",value:function(){this.setState({messageVisible:!1})}},{key:"shownotice22",value:function(a,b,c,f){this.setState({clickedProvider:a,clickedName:b,clickedServer:c,clickedDownload:f,notice22Visible:!0});setTimeout(function(){for(var a=document.getElementsByClassName("server"),b=0;b<=a.length-1;b++)a[b].select()},500)}},{key:"hidenotice22",value:function(){this.setState({notice22Visible:!1})}},{key:"render",value:function(){return React.createElement("div",
null,React.createElement(Message,{messageVisible:this.state.messageVisible,hideMessage:this.hideMessage}),React.createElement(notice22,{notice22Visible:this.state.notice22Visible,hidenotice22:this.hidenotice22,allProvidersFinished:this.allProvidersFinished,showMessage:this.showMessage,clickedProvider:this.state.clickedProvider,clickedName:this.state.clickedName,clickedServer:this.state.clickedServer,clickedDownload:this.state.clickedDownload}),Object.keys(this.state.allData).map(function(a,b){return React.createElement("div",
{className:"section",key:b,style:{height:20*this.state.allData[a].length+30+"px"}},React.createElement("h3",null,a),React.createElement(List,{provider:a,providerFinished:this.providerFinished,shownotice22:this.shownotice22,targets:this.state.allData[a]}))}.bind(this)))}}]);return b}(React.Component);function main(){ReactDOM.render(React.createElement(App,null),document.getElementById("result"))};